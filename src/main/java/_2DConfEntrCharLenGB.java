...
public class _2DConfEntrCharLenGB implements PlugInFilter {
	...
	public int setup(String arg, ImagePlus imp) {
		...
		if (choose == 0){}
		else if (choose == 1){IJ.run("Invert LUT");}
	...
	public void run(ImageProcessor ip) {
    	...
    	/** ---------Run the analysis---------------------------------- */         
		ToolEntrCharLen confentropy = new ToolEntrCharLen();
		confentropy.ip = ip;
		confentropy.path = path;
		confentropy.out();
	}
}
