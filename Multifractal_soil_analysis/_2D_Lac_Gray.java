...
public class _2D_Lac_Gray implements PlugInFilter {
	...
	public void run(ImageProcessor ip) {
		...
		gray_lacunarity gray_lacunarity_fun = new gray_lacunarity();
		//String str = new String(" 2D Multifractal Box Counting method");
		//lac_entropy_fun.str = "hola";
		gray_lacunarity_fun.ip = ip;
		gray_lacunarity_fun.path = path;
		gray_lacunarity_fun.out();
	}
}
